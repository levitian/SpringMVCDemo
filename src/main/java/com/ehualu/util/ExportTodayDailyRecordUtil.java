...
public class ExportTodayDailyRecordUtil {

	public static HSSFWorkbook export(List<DailyRecord> drs){
		...
		return wb;
/*		try {
			FileOutputStream fout = new FileOutputStream("d:/dailyRecord.xls");
			wb.write(fout);
			fout.close();
		} catch (Exception e) {
			e.printStackTrace();
